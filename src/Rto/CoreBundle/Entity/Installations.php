 ...
 * Installations
 *
 * @ORM\Table(name="installations", uniqueConstraints={@ORM\UniqueConstraint(name="id_UNIQUE", columns={"id"})}, indexes={@ORM\Index(name="fk_installation_users1_idx", columns={"users_id"}), @ORM\Index(name="fk_installation_locations1_idx", columns={"locations_id"})})
 * @ORM\Entity
 */
class Installations
{
